...
# adda_my
CUDA_VISIBLE_DEVICES=1 python adda_my.py data/office31 -d Office31 -s A -t W -a resnet50 --epochs1 20 --epochs2 20 --seed 1 --log logs/adda_my/Office31_A2W

CUDA_VISIBLE_DEVICES=4 nohup python adda_my.py data/office31 -d Office31 -s A -t W -a resnet50 --epochs1 20 --epochs2 20 --seed 1 --log logs/adda_my/Office31_A2W &
